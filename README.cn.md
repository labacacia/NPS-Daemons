...
| 层 | Daemon | 默认端口 | `v1.0.0-alpha.16` 状态 |
|----|--------|----------|------------------------|
...
版本号 `1.0.0-alpha.16` 替换为当前发布版本即可。
...
for pkg in npsd nps-runner nps-ingress nps-registry; do
    curl -LO "https://github.com/labacacia/nps-daemons/releases/download/v1.0.0-alpha.16/${pkg}_${VER}_amd64.deb"
