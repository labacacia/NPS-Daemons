...
app.Logger.LogInformation("nps-ingress v1.0.0-alpha.16 starting (L2 NCP-over-TLS terminator per NPS-RFC-0006 §6 — enable via NPSINGRESS_CERT_PATH; see docs/daemons/architecture.md)");
app.Run();
